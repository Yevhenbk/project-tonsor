	...
	return (
		<div className="div-master">
			<div className="div-child">
				<h1 className="prv-font-tit">POLÍTICA DE PRIVACIDAD</h1>
				<p className="prv-font-txt">
					El presente Política de Privacidad establece los términos en que Tonsor Barber Point usa y protege
				...
				<h1 className="prv-font-tit">Información que es recogida</h1>
				<p className="prv-font-txt">
				...
				<h1 className="prv-font-tit">Uso de la información recogida</h1>
				<p className="prv-font-txt">
					...
					Tonsor Barber Point está altamente comprometido para cumplir con el compromiso de mantener su
				...
				<h1 className="prv-font-tit">Enlaces a Terceros</h1>
				<p className="prv-font-txt">
				...
				<h1 className="prv-font-tit">Control de su información personal</h1>
				<p className="prv-font-txt">
					...
					en cualquier momento. Esta compañía no venderá, cederá ni distribuirá la información personal que es
					recopilada sin su consentimiento, salvo que sea requerido por un juez con un orden judicial. TONSOR
					Barber Point Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en
					cualquier momento. Esta politica de privacidad se han generado en politicadeprivacidadplantilla.com.
				</p>
			</div>
		</div>
	);
